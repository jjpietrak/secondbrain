...
## For future Claude
This is a nightly digest report generated by the nightly orchestrator (agents/nightly_run.sh).
It lists sources that passed ingest and are waiting for human approval before being added to
the wiki, research topics run, lint issues found, and any errors. Review and approve/reject
pending sources by updating meta/ingest_index.json (approve/reject verbs).
