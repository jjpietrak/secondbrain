...
3. Check if `$VAULT_ROOT/daily/YYYY-MM-DD.md` exists for today
...
7. Check the operation log for last night's sleeptime consolidation by reading `$VAULT_ROOT/wiki/log.md`:
