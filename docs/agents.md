...
This document lists the agents in the Second Brain v0.2 system, their status, and their responsibilities.

| Agent | Status | Description |
|---|---|---|
| Backend Agent | active | Backend Agent is used to write and create Second Brain code and later to perform cost & health audits. Has log audit skills and can propose structural updates. |
| Research Agent | active | Research agent taking care of keeping webscraping agent on track with research question and directions. TBD One Agent per research question + Director |
